...
for(let i=0;i<3;i++)
{
    ...
    {
        randomNmuber=Math.floor(Math.random()*3)+1;
        findanswer(i+1,randomNmuber)
...
const findanswer=(you,comp)=>{
    ...
    {
        same()
        content.innerText="Tie! Both are choose Rock";
    }
    ...
    {
        same()
        content.innerText="Tie! Both are choose Paper";
    }
    ...
    {
        same()
        content.innerText="Tie! Both are choose Scissors";
    }
}
